...
function Modal({ state, stateToggle, children }) {
          ...
          >
            ...
            >
              <ClickOutside
                ...
                className="absolute bottom-0 left-0 flex max-h-screen w-full overflow-hidden rounded-tl-2xl rounded-tr-2xl bg-white shadow-md lg:bottom-auto lg:left-1/2 lg:top-1/2 lg:max-h-[80vh] lg:w-auto lg:min-w-[512px] lg:max-w-[80vw] lg:-translate-x-1/2 lg:-translate-y-1/2 lg:rounded-2xl dark:bg-dark-500"
              >
